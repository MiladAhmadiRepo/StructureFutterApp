...
class Carousel extends StatefulWidget {
  ...
  //Enable/Disable the auto play of the utils.slider. Default true
  final bool autoplay;

  //Duration of the Auto play utils.slider by seconds. Default 3 seconds
